...
class LocalExplainer:
    ...
    def explain(self, data, labels, distances, label=0, num_features=5):
        ...
        easy_model.fit_and_valid(train_loader, test_loader, criterion, optimizer, scheduler, early_stopping,
                                 epochs=self.epochs, device=device, regularization='mono_reguralization', lmd=0.3)
        ...
        fuzzy_out = list(easy_model.mobius().values())[1:]
